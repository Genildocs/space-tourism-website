...
export default function Moon() {
    return (
        <div className="text-center text-white p-5">                  
            <div >
                <h1 className="text-[3.5rem] sm:text-[5rem] uppercase mt-5 font-normal font-Bellefair">{data.destinations[0].name}</h1>
                <p className="text-[0.9rem] sm:text-[1.2rem] mb-5 font-normal font-Barlow text-secundary text-center leading-6">{data.destinations[0].description}</p>
            </div>
